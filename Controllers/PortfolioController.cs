...
namespace api.Controllers
{
    ...
    public class PortfolioController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeletePortfolio(string symbol){
            ...
            var filterStrock = userPortfolio.Where(s => s.Symbol.ToLower() == symbol.ToLower()).ToList();
            if (filterStrock.Count() == 1)
            {
                await _portfolioRepo.DeletePortfoli(appUser, symbol);
